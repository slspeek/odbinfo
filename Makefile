...
pythonsources=$$(find -name \*.py -and -not -ipath ./odbinfo/test/pure/data\* -and -not -ipath ./odbinfo/test/oo/data\* -and -not -ipath ./target/\* -and -not -ipath ./odbinfo/pure/parser/oobasic/\* -and -not -ipath ./odbinfo/pure/parser/sqlite/\* )
