...
def read_metadata_in_test(testdb_doc, monkeypatch):
    ...
    return read_metadata(dsource, dbfilename)
...
def read_metadata_regression_test(testdb_doc, filename, data_regression,
    ...
    metadata_read = read_metadata_in_test(testdb_doc, monkeypatch)
    # pylint:disable=protected-access
    # metadata_read._reset_obj_ids()
